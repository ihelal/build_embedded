#ifndef _ROS_SERVICE_GetIRExposure_h
#define _ROS_SERVICE_GetIRExposure_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GETIREXPOSURE[] = "astra_camera/GetIRExposure";

  class GetIRExposureRequest : public ros::Msg
  {
    public:

    GetIRExposureRequest()
    {
    }
    ...
    const char * getType(){ return GETIREXPOSURE; };
    const char * getMD5(){ return "d41d8cd98f00b204e9800998ecf8427e"; };

  };

  class GetIRExposureResponse : public ros::Msg
  {
    public:
      typedef int32_t _exposure_type;
      _exposure_type exposure;

    GetIRExposureResponse():
      exposure(0)
    {
    }
